    ...
    def load_index(self, filepath: str = None):
        ...
        try:
            if os.path.exists(filepath):
                ...
                print("📚 Se utilizará el índice en memoria")

        except Exception as e:
            print(f"⚠️ No se pudo cargar índice previo: {e}")
            print(
                "📚 Regenerando índice en memoria (esto es normal en primera ejecución)"
            )
            # No es crítico, el sistema funciona con el índice en memoria
